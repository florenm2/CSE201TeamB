...
public class displayFinalExams extends JFrame{
		...
		for(Course scheduled: coursesScheduled){
			...
			if(scheduled.getStartTime() == 1300 &&
					(scheduled.getDays().equals("MW") || 
							scheduled.getDays().equals("MWF") ||
							scheduled.getDays().equals("WF"))){
				System.out.println("Success: " + scheduled.getCourseNum());
				time3.setText(scheduled.getTitle());
				validate();
			}
			else{
				time3.setText("test");
	...
	private Component thursday(){
		JPanel thur = new JPanel();
	...
	public static void main(String[] args){
		...
		c381.setSubject("CSE");
		c381.setDays("MW");
		c381.setStartTime(1000);
		c381.setEndTime(1100);
